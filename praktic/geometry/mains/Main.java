...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Circle lingkar = new Circle();//inisiasi objek dari class Circle dengan parameter kosong
        lingkar.setID(setID);//inputan setID dipanggil sehingga nilai setID dapat ditampilkan 
        lingkar.setRadius(setRadius);//inputan SetRadius dipanggil sehingga dapat menampilkan hasil inputan
        ...
        Rectangle persegi = new Rectangle(ID, panjang,lebar);//inisiasi class Rectangle dengan parameter ID, panjang, lebar
